...
RUN wget https://github.com/webosbrew/dev-manager-desktop/releases/download/v1.12.1/web-os-dev-manager_1.12.1_amd64.deb
RUN apt-get install ./v1.12.1/web-os-dev-manager_1.12.1_amd64.deb
